...
public class Jobs {
	...
	By btnclkJobsBySector = By.xpath("//*[@id='item-22808']/div[2]/p/a");   	   //find element view details button by text
	By btnapply = By.xpath("//a[contains(.,'Apply')]");              			   //find element view details button by text
	...
	public void clkJobsBySector() {
		ldriver.findElement(btnclkJobsBySector).click();
	}	
	
	public void clickApply() {
		ldriver.findElement(btnapply).click();
	}
}
